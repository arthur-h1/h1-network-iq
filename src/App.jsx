  ...
  return (
    <div className="min-h-screen flex bg-slate-950">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-950 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="absolute bottom-32 left-10 w-48 h-48 bg-pink-700/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl flex items-center justify-center shadow-lg shadow-blue-600/30">
              <span className="text-2xl font-bold text-white">H1</span>
            </div>
            <div>
              <span className="text-white text-xl font-semibold">Network</span>
              <span className="text-blue-400 text-xl font-bold">IQ</span>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-6">
          <h1 className="text-4xl font-bold text-white leading-tight">
            Validate Network<br />
            <span className="text-blue-400">Adequacy</span> with<br />
            Confidence
          </h1>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            ...
            <div>
              ...
              <span className="text-blue-400 text-lg font-bold">IQ</span>
            </div>
          </div>
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-slate-700/50 border border-slate-600/50 text-white placeholder-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all"
                />
              </div>
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-xl shadow-lg shadow-blue-600/30 transition-all flex items-center justify-center gap-2 disabled:opacity-70"
              >
                {isLoading ? (
