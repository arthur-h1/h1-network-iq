  ...
  return (
    <div className="h-full overflow-y-auto pb-20">
      <div className="max-w-5xl mx-auto">
        ...
        {isSimulationMode && (
          <div className="mb-6 p-4 bg-teal-500/10 border-2 border-teal-500/40 rounded-xl">
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-teal-500 rounded-full animate-pulse" />
              <div>
                <p className="text-teal-600 font-semibold text-sm">Simulation Mode Active</p>
          ...
          <div className={`mb-6 p-4 rounded-xl border-2 ${
            ...
            <div className="flex items-center gap-3">
              ...
              <p className={`text-sm font-medium ${
                exportStatus.type === 'success' ? 'text-teal-600' : 'text-rose-600'
              }`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white border-2 border-slate-200 rounded-2xl p-6 hover:border-teal-500/50 transition-all shadow-sm">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="text-slate-900 font-semibold text-lg mb-1">Provider Directory</h3>
                <p className="text-slate-600 text-sm mb-4">
                  Complete provider list with NPI, specialty, state, confidence ratings, and status
                </p>
                <div className="flex items-center gap-2 text-xs text-slate-600 mb-4">
                  <span className="px-2 py-1 bg-slate-100 rounded">CSV Format</span>
                  <span className="px-2 py-1 bg-slate-100 rounded">~50,000 providers</span>
                  {isSimulationMode && (
                    <span className="px-2 py-1 bg-teal-500/20 text-teal-600 rounded">Simulation data included</span>
                  )}
                </div>
                <button
                  onClick={() => handleExport('directory')}
                  disabled={isExporting}
                  className="w-full bg-slate-100 hover:bg-slate-200 text-slate-900 px-4 py-2 rounded-lg font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 border border-slate-300"
                >
          ...
          <div className="bg-white border-2 border-slate-200 rounded-2xl p-6 hover:border-teal-500/50 transition-all shadow-sm">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="text-slate-900 font-semibold text-lg mb-1">Adequacy Results</h3>
                <p className="text-slate-600 text-sm mb-4">
                  State-by-state network adequacy metrics with baseline vs current comparison
                </p>
                <div className="flex items-center gap-2 text-xs text-slate-600 mb-4">
                  <span className="px-2 py-1 bg-slate-100 rounded">CSV Format</span>
                  <span className="px-2 py-1 bg-slate-100 rounded">50 states</span>
                  {isSimulationMode && (
                    <span className="px-2 py-1 bg-teal-500/20 text-teal-600 rounded">Shows impact</span>
                  )}
                </div>
                <button
          ...
          <div className="bg-white border-2 border-slate-200 rounded-2xl p-6 hover:border-teal-500/50 transition-all shadow-sm">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="text-slate-900 font-semibold text-lg mb-1">KPI Summary</h3>
                <p className="text-slate-600 text-sm mb-4">
                  Key performance indicators across network, adequacy, and compliance metrics
                </p>
                <div className="flex items-center gap-2 text-xs text-slate-600 mb-4">
                  <span className="px-2 py-1 bg-slate-100 rounded">CSV Format</span>
                  <span className="px-2 py-1 bg-slate-100 rounded">18 metrics</span>
                  {isSimulationMode && (
                    <span className="px-2 py-1 bg-teal-500/20 text-teal-600 rounded">Includes impact summary</span>
                  )}
                </div>
                <button
          ...
          <div className={`bg-white border-2 rounded-2xl p-6 transition-all shadow-sm ${
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="text-slate-900 font-semibold text-lg mb-1">Impact Report</h3>
                <p className="text-slate-600 text-sm mb-4">
                ...
                <div className="flex items-center gap-2 text-xs text-slate-600 mb-4">
                  <span className="px-2 py-1 bg-slate-100 rounded">CSV Format</span>
                  {isSimulationMode && removedProviders.size > 0 ? (
                    <span className="px-2 py-1 bg-teal-500/20 text-teal-600 rounded">Simulation active</span>
                  ) : (
                    <span className="px-2 py-1 bg-slate-100 rounded">Requires simulation mode</span>
                  )}
                </div>
                <button
        ...
        <div className="mt-8 p-4 bg-slate-50 border border-slate-200 rounded-xl">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-slate-600">
              <p className="mb-2">
                <strong className="text-slate-900">Export Information:</strong>
              </p>
